...
namespace RemoteAnalyst.Repository.Models
{
    public class DailyAppUnrated
    {
        ...
        {
            DailyAppUnrated other = obj as DailyAppUnrated;
            if (other == null) return false;
            return SystemSerialNum == other.SystemSerialNum && DataDate == other.DataDate && AttributeID == other.AttributeID && AppId == other.AppId;
        }
        ...
        public override int GetHashCode()
        {
            ...
            hash = hash * 23 + AppId.GetHashCode();
            cachedHashCode = hash;
